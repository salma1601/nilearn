...
#    t_r = 2.5
    ...
    rescaling = 100. / np.mean(region_raw, axis=0)
    region_ts = nilearn.signal.clean(region_raw, detrend=True,
                                     standardize=False,
                                     confounds=[hv_confounds, confound_file],
                                     low_pass=low_pass, high_pass=high_pass,
                                     t_r=t_r)
    region_ts2 = nilearn.signal.clean(rescaling * region_raw, detrend=True,
                                     standardize=False,
                                     confounds=[hv_confounds, confound_file],
                                     low_pass=low_pass, high_pass=high_pass,
                                     t_r=t_r)
    region_ts4 = nilearn.signal.clean(region_raw, detrend=True,
                                     standardize=True,
                                     confounds=[hv_confounds, confound_file],
                                     low_pass=low_pass, high_pass=high_pass,
                                     t_r=t_r)
...
np.save('/home/salma/CODE/Parietal/nilearn/cleaned_signal_MSDL_default',
        subjects)
np.save('/home/salma/CODE/Parietal/nilearn/cleaned_scaled_signal_MSDL_default',
        subjects3)
np.save('/home/salma/CODE/Parietal/nilearn/cleaned_standardized_signal_MSDL_default',
        subjects4)