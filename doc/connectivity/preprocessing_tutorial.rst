...
This page is a preprocessing tutorial articulated on the analysis of the ADHD
dataset. It shows how to explore the ROIs signals for a later functional
...
Extracting signal from ROIs
===========================

Choosing the ROIs
-----------------

blabla on the different possibilities: anatomical vs functional, whole brain vs
selected areas, comment on not removing regions because of low statistical
power

The MSDL atlas is a probabilistic atals of 39 functional regions, extracted
from 20 healthy adults at rest (variant of ICA), see ref. It includes regions from the default mode,
the motor, auditory, visual, attention, saliency networks.

.. figure:: ../auto_examples/decoding/images/plot_msdl.png
   :target: ../auto_examples/decoding/plot_msdl.html
   :scale: 30
   :align: left
...
Exploring raw signals from ROIs and confounds
=============================================

For a functional connectivity prospective
...
Checking the connectivity maps
==============================
...
Exploring the ROIs signals and the confounds
============================================
