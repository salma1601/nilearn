...
We show the importance of defining good confounds signals: the
first correlation matrix is computed after regressing out simple
confounds signals: movement regressors, white matter and CSF signals, ...
The second one is without any confounds: all regions are connected to
each other.

We also explore the impact of different counfounds choices on voxel-to-voxel
...
###############################################################################
# Check the relevance of chosen confounds: After confounds removal,
# the distribution of voxel-to-voxel correlations should be tight
# and approximately centered to zero.
...
# Compare to high variance confounds removal
