...
from personal_datasets import fetch_adhd_neuroimage
...
dataset = fetch_adhd_neuroimage(data_dir='/volatile/new/salma/' + \
    'ADHD_data/NeuroIMAGE')
...
for subject_n in range(n_subjects):
    ...
    region_ts = masker.fit_transform(filename, confounds=None)
